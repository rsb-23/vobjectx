...
def test_general_behavior():
    ...
    assert sorted(BehaviorRegistry.keys()) == [
        ...
        "EXRULE", "FN", "FREEBUSY", "GEO", "HCALENDAR", "LABEL", "LAST-MODIFIED", "LOCATION", "METHOD", "N", "ORG",
        "PHOTO", "PRODID", "RDATE", "RECURRENCE-ID", "RELATED-TO", "REQUEST-STATUS", "RESOURCES", "RRULE", "STANDARD",
